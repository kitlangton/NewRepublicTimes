...
(function() {
  $(function() {
    ...
    $(".trigger").click(function() {
      return $(this).closest('.assign').find(".character-select").addClass('reveal-select');
    });
    $(".name").hover(function() {
      if ($(this).hasClass('void')) {
        return;
      }
      return $(this).children(".empty").each(function() {
        return $(this).addClass('reveal');
      });
    }, function() {
      return $(this).children(".empty").each(function() {
        return $(this).removeClass('reveal');
      });
    });
    $('.best_in_place').bind("ajax:success", function(data) {
      if ($(this).data('bip-value') === "") {
        return $(this).parent(".name-element").addClass("empty");
      } else {
        $(this).parent(".name-element").removeClass("empty");
        return $(this).parent(".name-element").removeClass("reveal");
      }
    });
    $('.best_in_place').on('focus', 'input', function() {
      $(this).closest(".name-element").removeClass("empty");
      return $(this).closest(".name-element").removeClass("reveal");
    });
    return $('.best_in_place').on('blur', 'input', function() {
      if ($(this).val() === "") {
        return $(this).closest(".name-element").addClass("empty");
      }
    });
  });
